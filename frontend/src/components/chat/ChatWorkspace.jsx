...
export const ChatWorkspace = ({ onBackToLanding }) => {
  const { t } = useLanguage();
      ...
      <div className="chat-main">
        ...
        <div className="chat-topbar">
            ...
            >
              {isOffline ? (
                <>
                  ...
                  <span>OFFLINE ({evaluation?.distanceToBoundaryKm?.toFixed(1) || '0.0'}km · {evaluation?.state || 'NORMAL'})</span>
                </>
              ) : (
                <>
                  <span className="chat-status-dot" />
                  <span>{t('onlineStatus', 'Online · Safety Active')}</span>
                </>
              )}
            </button>
          ...
          <div className="chat-topbar-right">
            ...
            <LanguageSwitcherButton variant="compact" />
            ...
            >
              ...
              <span className="hidden sm:inline">{t('safetySimulator', 'Safety Simulator')}</span>
            </button>
            ...
            >
              ...
              <span className="hidden sm:inline">{t('backOverview', 'Overview')}</span>
            </button>
          </div>
        </div>
