...
export const MarineMap = ({
  ...
  return (
    <div className="relative w-full h-full bg-black overflow-hidden flex flex-col select-none">
      ...
      <div className="relative flex-1 w-full h-full bg-[radial-gradient(#1f1f1f_1px,transparent_1px)] [background-size:28px_28px] overflow-hidden">
      ...
      <div className="h-9 bg-navy-950/95 border-t border-slate-800/90 px-4 flex items-center justify-between text-[11px] font-mono text-slate-400">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <span className="text-slate-400">MOSDAC & INCOIS Active</span>
        </div>
      </div>
    </div>
  );
